...
/** All supported IANA timezone IDs (browser-native, no extra package). */
                ...
                {timezones.map((tz) => (
                  <button
                    ...
                    className={cn(
                      ...
                      value === tz && 'bg-accent text-accent-foreground',
                    )}
                  >
                    ...
                    {value === tz && <Check className="h-3.5 w-3.5 shrink-0 text-primary" />}
                  </button>
                ))}
              </div>
            ))}
